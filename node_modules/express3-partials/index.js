...
module.exports = function(){
  return function(req,res,next){
    ...
    res.render = function(name, options, fn){
      // the template directory path stored in the options object
...
function lookup(root, view, ext){
  var template_dir = path.dirname(view);
  ...
  view = resolve(root, template_dir, 'partials', name+ext)
  if( exists(view) ) return view;
